...
cooklang$1.Metadata = cooklang$1.Timer = cooklang$1.Cookware = cooklang$1.Ingredient = cooklang$1.Step = Recipe_1 = cooklang$1.Recipe = void 0;
const COMMENT_REGEX = /(--.*)|(\[-(.|\n)+?-\])/g;
...
var Recipe_1 = cooklang$1.Recipe = Recipe;
// a single recipe step
class Step extends base$1 {
    constructor(s) {
        super(s);
        this.line = [];
...
cooklang$1.Step = Step;
// ingredients
class Ingredient extends base$1 {
    constructor(s) {
        var _a;
        super(s);
...
cooklang$1.Ingredient = Ingredient;
// cookware
class Cookware extends base$1 {
    constructor(s) {
        super(s);
        if (s instanceof Array || typeof s === 'string') {
...
cooklang$1.Cookware = Cookware;
// timer
class Timer extends base$1 {
    constructor(s) {
        super(s);
        if (s instanceof Array || typeof s === 'string') {
...
class CookView extends obsidian.TextFileView {
    ...
    getViewData() {
        ...
        this.recipe = new Recipe_1(this.data);
        return this.data;
    }
    ...
    renderPreview(recipe) {
        ...
        recipe.steps.forEach((step, i) => {
            ...
            const stepText = step.text || step.line || [];
            stepText.forEach((part) => {
                var _a, _b, _c, _d;
                if (typeof part === 'string') {
                    ...
                    if (part.type === 'ingredient') {
                        ...
                        this.makeTimer(button, (_c = part.amount) !== null && _c !== void 0 ? _c : 0, (_d = part.name) !== null && _d !== void 0 ? _d : '');
                    }
                }
            });
        });
